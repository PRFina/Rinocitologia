...
public class CellExplorer  {
    ...
    public CellExplorer(Stage primaryStage, Prove prove) {

        VBox root = new VBox();

        this.prove = prove;
        mImageView = new ImageDisplay();
        ...
        root.getChildren().addAll(getMenuBar(), mFileView, mImageView, getToolBar());
